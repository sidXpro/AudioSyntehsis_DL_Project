...
if __name__ == "__main__":
    ...
    test_audio_path = "log1/testset_data"
    # latent_diffusion_model_log_path = args.log_path
    latent_diffusion_model_log_path = "log/latent_diffusion/2023_08_23_reproduce_audioldm/audioldm_original_medium"
