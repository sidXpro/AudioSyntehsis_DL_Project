...
if __name__ == "__main__":
    ...
    config = yaml.load(
        open(
            "/storage/siddharath/Foley/AudioLDM-training-finetuning/audioldm_train/config/2023_08_23_reproduce_audioldm/audioldm_original1.yaml",
            "r",
        ),
    ...
    dataset = AudioDataset(
        config=config, split="val", waveform_only=False, add_ons=add_ons
    )
