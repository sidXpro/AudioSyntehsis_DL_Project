...
metadata_json_list = [
    "data/DATA2/metadata/audioUrbanMix/esc_custom_train_label.json",
    "data/DATA2/metadata/audioUrbanMix/esc_custom_test_label.json",
]
missing_files_count = 0
for metadata_json in metadata_json_list:
    metadata = load_json(metadata_json)["data"]
    for datapoint in tqdm(metadata):
        audiopath = os.path.join("./data/DATA2/esc_custom", datapoint["wav"])
